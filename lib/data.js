...
// Cities list for forms — matches the office locations returned by the
// backend /offices endpoint (Nashik head office + Mumbai, Pune, Nagpur)
export const citiesList = ["Nashik", "Mumbai", "Pune", "Nagpur"];
